...
const Footer = ({ cards, setPageNumber, pageNumber, numberOfPages, pages }) => {
  ...
  useEffect(() => {
    const fetchCardCount = async () => {
      try {
        ...
        setError('Error fetching card count. Please try again later.');
        setLoading(false);
      }
    };
    ...
    <div>   
      ...
      <div>   
        <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
          {/* Left Arrow Button */}
          <a href="#" onClick={gotoPrevious} className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
          ...
          {/* Replace with dynamic page numbers based on your logic */}
          {/* 1 */}
          ...
          {/* Right Arrow Button */}
          <a href="#" onClick={gotoNext} className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
